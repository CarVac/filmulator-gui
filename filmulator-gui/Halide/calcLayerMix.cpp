...
Func calcLayerMix(Func developer_concentration,
  Expr layer_mix_const,
  Expr timestep,
  Expr layer_time_divisor,
  Expr reservoir_developer_concentration)
{
...
int main(int argc, char **argv)
{
  ...
  dDevelConc = calcLayerMix(developerConcentration, layerMixConst, stepTime, layerTimeDivisor, reservoirConcentration);
