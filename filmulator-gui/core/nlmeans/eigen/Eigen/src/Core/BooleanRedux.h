...
namespace internal {
  ...
  template<typename Derived> struct all_unroller<Derived, 0>
  {
  ...
  template<typename Derived> struct any_unroller<Derived, 0>
  {
 ...
 * \sa all(), any()
 */
template<typename Derived> inline Eigen::Index DenseBase<Derived>::count() const
{
