...
namespace internal {
  template<typename ViewOp, typename MatrixType> struct traits<CwiseUnaryView<ViewOp, MatrixType>> : traits<MatrixType>
  {
    ...
    enum {
      ...
      Flags =
        traits<_MatrixTypeNested>::Flags
...
template<typename ViewOp, typename MatrixType, typename StorageKind> class CwiseUnaryViewImpl;
...
public:
  ...
  /** \returns the nested expression */
  typename internal::remove_reference<MatrixTypeNested>::type &nestedExpression()
  {
