...
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE typename ScalarBinaryOpTraits<typename internal::traits<Derived>::Scalar,
 ...
 */
template<typename Derived>
EIGEN_STRONG_INLINE const typename MatrixBase<Derived>::PlainObject MatrixBase<Derived>::normalized() const
{
 ...
 * \sa norm(), normalized()
 */
template<typename Derived> EIGEN_STRONG_INLINE void MatrixBase<Derived>::normalize()
{
 ...
 */
template<typename Derived>
EIGEN_STRONG_INLINE const typename MatrixBase<Derived>::PlainObject MatrixBase<Derived>::stableNormalized() const
{
 ...
 */
template<typename Derived> EIGEN_STRONG_INLINE void MatrixBase<Derived>::stableNormalize()
{
