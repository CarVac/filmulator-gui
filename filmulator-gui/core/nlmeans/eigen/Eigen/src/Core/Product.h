...
namespace internal {
  ...
  template<typename Lhs, typename Rhs, int Option> struct traits<Product<Lhs, Rhs, Option>>
  {
...
public:
  ...
  typedef typename ProductImpl<Lhs,
    Rhs,
    Option,
...
namespace internal {
  ...
  public:
    ...
    EIGEN_STRONG_INLINE operator const Scalar() const { return internal::evaluator<ProductXpr>(derived()).coeff(0, 0); }
  };
