...
namespace internal {
  ...
  template<typename Scalar, typename Index, int Pack1, int Pack2_dummy, int StorageOrder> struct symm_pack_lhs
  {
  ...
  template<typename Scalar, typename Index, int nr, int StorageOrder> struct symm_pack_rhs
  {
    enum { PacketSize = packet_traits<Scalar>::size };
    ...
    RowMajor>
  {
      ...
      level3_blocking<Scalar, Scalar> &blocking)
    {
      product_selfadjoint_matrix<Scalar,
        ...
        ColMajor>::run(cols, rows, rhs, rhsStride, lhs, lhsStride, res, resStride, alpha, blocking);
    }
  };
  ...
  template<typename Scalar,
    ...
    int RhsStorageOrder,
    bool ConjugateRhs>
  EIGEN_DONT_INLINE void product_selfadjoint_matrix<Scalar,
    Index,
    LhsStorageOrder,
    true,
    ConjugateLhs,
...
namespace internal {
  ...
  struct selfadjoint_product_impl<Lhs, LhsMode, false, Rhs, RhsMode, false>
  {
    ...
    template<typename Dest> static void run(Dest &dst, const Lhs &a_lhs, const Rhs &a_rhs, const Scalar &alpha)
    {
      ...
      internal::product_selfadjoint_matrix<Scalar,
        ...
        internal::traits<Dest>::Flags & RowMajorBit ? RowMajor : ColMajor>::run(lhs.rows(),
        rhs.cols(),// sizes
        &lhs.coeffRef(0, 0),
