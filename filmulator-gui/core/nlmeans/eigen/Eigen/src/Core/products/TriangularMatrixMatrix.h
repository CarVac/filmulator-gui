...
namespace internal {
    ...
    Version>
  {
      ...
      level3_blocking<Scalar, Scalar> &blocking)
    {
      product_triangular_matrix_matrix<Scalar,
        ...
        ConjugateLhs,
        ColMajor>::run(cols, rows, depth, rhs, rhsStride, lhs, lhsStride, res, resStride, alpha, blocking);
    }
  };
  ...
  template<typename Scalar,
    ...
    bool ConjugateRhs,
    int Version>
  EIGEN_DONT_INLINE void product_triangular_matrix_matrix<Scalar,
    Index,
    Mode,
    true,
    LhsStorageOrder,
  ...
  struct triangular_product_impl<Mode, LhsIsTriangular, Lhs, false, Rhs, false>
  {
    ...
    static void run(Dest &dst, const Lhs &a_lhs, const Rhs &a_rhs, const typename Dest::Scalar &alpha)
    {
      ...
      internal::product_triangular_matrix_matrix<Scalar,
        ...
        (internal::traits<Dest>::Flags & RowMajorBit) ? RowMajor : ColMajor>::run(stripedRows,
        stripedCols,
        stripedDepth,// sizes
        &lhs.coeffRef(0, 0),
