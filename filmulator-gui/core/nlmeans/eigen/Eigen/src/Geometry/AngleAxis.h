...
public:
   ...
   */
  template<typename QuatDerived> EIGEN_DEVICE_FUNC inline explicit AngleAxis(const QuaternionBase<QuatDerived> &q)
  {
    *this = q;
  }
  ...
  EIGEN_DEVICE_FUNC bool isApprox(const AngleAxis &other,
