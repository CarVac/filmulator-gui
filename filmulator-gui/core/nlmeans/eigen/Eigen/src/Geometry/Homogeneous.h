  ...
  VectorwiseOp<ExpressionType, Direction>::hnormalized() const
{
  return HNormalized_Block(_expression(),
    ...
    .cwiseQuotient(Replicate<HNormalized_Factors,
      ...
      Direction == Horizontal ? HNormalized_SizeMinusOne : 1>(HNormalized_Factors(_expression(),
...
namespace internal {
    ...
    : public ReturnByValue<homogeneous_left_product_impl<Homogeneous<MatrixType, Vertical>, Lhs>>
  {
    ...
    template<typename Dest> EIGEN_DEVICE_FUNC void evalTo(Dest &dst) const
    {
      ...
      dst = Block<const LhsMatrixTypeNested,
              ...
              m_lhs, 0, 0, m_lhs.rows(), m_lhs.cols() - 1)
            * m_rhs;
    ...
    Dense2Dense>
  {
    ...
    EIGEN_DEVICE_FUNC static void
      run(DstXprType &dst, const SrcXprType &src, const internal::assign_op<Scalar, typename ArgType::Scalar> &)
    {
  ...
  {
    template<typename Dest> static void evalTo(Dest &dst, const Lhs &lhs, const Homogeneous<RhsArg, Vertical> &rhs)
    {
