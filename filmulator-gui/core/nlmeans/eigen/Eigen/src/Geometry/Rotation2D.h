...
public:
   ...
   */
  template<typename Derived> EIGEN_DEVICE_FUNC explicit Rotation2D(const MatrixBase<Derived> &m)
  {
   ...
   * \sa fromRotationMatrix()
   */
  template<typename Derived> EIGEN_DEVICE_FUNC Rotation2D &operator=(const MatrixBase<Derived> &m)
  {
  ...
  EIGEN_DEVICE_FUNC bool isApprox(const Rotation2D &other,
