...
namespace internal {
  template<typename CholMatrixType, typename InputMatrixType> struct simplicial_cholesky_grab_input
  {
  ...
  template<typename MatrixType> struct simplicial_cholesky_grab_input<MatrixType, MatrixType>
  {
...
public:
  ...
  /** Default constructor */
  SimplicialCholeskyBase() : m_info(Success), m_shiftOffset(0), m_shiftScale(1) {}

  explicit SimplicialCholeskyBase(const MatrixType &matrix) : m_info(Success), m_shiftOffset(0), m_shiftScale(1)
  {
