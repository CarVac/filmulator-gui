...
namespace internal {
  ...
  template<typename _Scalar, typename _StorageIndex> Index AmbiVector<_Scalar, _StorageIndex>::nonZeros() const
  {
    if (m_mode == IsSparse)
      return m_llSize;
    else
  ...
  template<typename _Scalar, typename _StorageIndex> void AmbiVector<_Scalar, _StorageIndex>::setZero()
  {
    if (m_mode == IsDense) {
  ...
  template<typename _Scalar, typename _StorageIndex> _Scalar &AmbiVector<_Scalar, _StorageIndex>::coeffRef(Index i)
  {
    if (m_mode == IsDense)
      return m_buffer[i];
    else {
  ...
  template<typename _Scalar, typename _StorageIndex> _Scalar &AmbiVector<_Scalar, _StorageIndex>::coeff(Index i)
  {
    if (m_mode == IsDense)
      return m_buffer[i];
    else {
  ...
  template<typename _Scalar, typename _StorageIndex> class AmbiVector<_Scalar, _StorageIndex>::Iterator
  {
  public:
    typedef _Scalar Scalar;
    typedef typename NumTraits<Scalar>::Real RealScalar;
