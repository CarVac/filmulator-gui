 ...
 * class SparseMatrix.
 * \tparam Options specifies whether the a standard compressed format is required \c Options is  \c
...
namespace internal {
  ...
  // FIXME shall we introduce a general evaluatior_ref that we can specialize for any sparse object once, and thus
