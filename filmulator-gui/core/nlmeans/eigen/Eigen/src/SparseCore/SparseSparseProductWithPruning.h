...
namespace internal {
  ...
  static void sparse_sparse_product_with_pruning_impl(const Lhs &lhs,
    const Rhs &rhs,
    ResultType &res,
  ...
  struct sparse_sparse_product_with_pruning_selector<Lhs, Rhs, ResultType, RowMajor, RowMajor, ColMajor>
  {
    ...
    static void run(const Lhs &lhs, const Rhs &rhs, ResultType &res, const RealScalar &tolerance)
    {
      ...
      internal::sparse_sparse_product_with_pruning_impl<ColMajorMatrixLhs, ColMajorMatrixRhs, ResultType>(
  ...
  struct sparse_sparse_product_with_pruning_selector<Lhs, Rhs, ResultType, ColMajor, RowMajor, RowMajor>
  {
    ...
    static void run(const Lhs &lhs, const Rhs &rhs, ResultType &res, const RealScalar &tolerance)
    {
      ...
      sparse_sparse_product_with_pruning_selector<RowMajorMatrixLhs, Rhs, ResultType, RowMajor, RowMajor>(
  ...
  struct sparse_sparse_product_with_pruning_selector<Lhs, Rhs, ResultType, ColMajor, RowMajor, ColMajor>
  {
    ...
    static void run(const Lhs &lhs, const Rhs &rhs, ResultType &res, const RealScalar &tolerance)
    {
      typedef SparseMatrix<typename Rhs::Scalar, ColMajor, typename Lhs::StorageIndex> ColMajorMatrixRhs;
      ColMajorMatrixRhs colRhs(rhs);
      internal::sparse_sparse_product_with_pruning_impl<Lhs, ColMajorMatrixRhs, ResultType>(
  ...
  struct sparse_sparse_product_with_pruning_selector<Lhs, Rhs, ResultType, RowMajor, ColMajor, ColMajor>
  {
    ...
    static void run(const Lhs &lhs, const Rhs &rhs, ResultType &res, const RealScalar &tolerance)
    {
      typedef SparseMatrix<typename Lhs::Scalar, ColMajor, typename Lhs::StorageIndex> ColMajorMatrixLhs;
      ColMajorMatrixLhs colLhs(lhs);
      internal::sparse_sparse_product_with_pruning_impl<ColMajorMatrixLhs, Rhs, ResultType>(
