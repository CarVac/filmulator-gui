...
namespace internal {
  ...
  protected:
    ...
    void relax_snode(const Index n,
      ...
      IndexVector &descendants,
      IndexVector &relax_end);
    Index snode_dfs(const Index jcol,
      const Index kcol,
    ...
    void dfs_kernel(const StorageIndex jj,
      IndexVector &perm_r,
      Index &nseg,
    ...
    void panel_bmod(const Index m,
      ...
      IndexVector &repfnz,
      GlobalLU_t &glu);
    Index column_dfs(const Index m,
      const Index jcol,
      IndexVector &perm_r,
      Index maxsuper,
      Index &nseg,
      ...
      IndexVector &xplore,
      GlobalLU_t &glu);
    Index column_bmod(const Index jcol,
      const Index nseg,
      ...
      Index fpanelc,
      GlobalLU_t &glu);
    Index copy_to_ucol(const Index jcol,
      const Index nseg,
      IndexVector &segrep,
      BlockIndexVector repfnz,
      IndexVector &perm_r,
