...
#define DECL_GSSVX(PREFIX, FLOATTYPE, KEYTYPE)                      \
  extern "C" {                                                      \
  extern void PREFIX##gssvx(superlu_options_t *,                    \
    SuperMatrix *,                                                  \
    int *,                                                          \
    int *,                                                          \
    int *,                                                          \
  ...
  inline float SuperLU_gssvx(superlu_options_t *options,            \
    SuperMatrix *A,                                                 \
    int *perm_c,                                                    \
    int *perm_r,                                                    \
    int *etree,                                                     \
...
#define DECL_GSISX(PREFIX, FLOATTYPE, KEYTYPE)                      \
  extern "C" {                                                      \
  extern void PREFIX##gsisx(superlu_options_t *,                    \
    SuperMatrix *,                                                  \
    int *,                                                          \
    int *,                                                          \
    int *,                                                          \
  ...
  inline float SuperLU_gsisx(superlu_options_t *options,            \
    SuperMatrix *A,                                                 \
    int *perm_c,                                                    \
    int *perm_r,                                                    \
    int *etree,                                                     \
...
struct SluMatrix : SuperMatrix
{
  ...
  template<typename MatrixType> static SluMatrix Map(MatrixBase<MatrixType> &_mat)
  {
  ...
  template<typename MatrixType> static SluMatrix Map(SparseMatrixBase<MatrixType> &a_mat)
  {
...
template<typename Derived> struct SluMatrixMapHelper<SparseMatrixBase<Derived>>
{
...
namespace internal {
  ...
  template<typename MatrixType> SluMatrix asSluMatrix(MatrixType &mat) { return SluMatrix::Map(mat); }
  ...
  MappedSparseMatrix<Scalar, Flags, Index> map_superlu(SluMatrix &sluMat)
  {
    ...
    return MappedSparseMatrix<Scalar, Flags, Index>(sluMat.nrow,
      sluMat.ncol,
      sluMat.storage.outerInd[outerSize],
      sluMat.storage.outerInd,
...
template<typename MatrixType> void SuperLU<MatrixType>::factorize(const MatrixType &a)
{
...
//
template<typename MatrixType, typename Derived> void SuperLUBase<MatrixType, Derived>::extractData() const
{
...
template<typename _MatrixType> class SuperILU : public SuperLUBase<_MatrixType, SuperILU<_MatrixType>>
{
public:
