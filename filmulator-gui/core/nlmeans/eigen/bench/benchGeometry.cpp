...
template<class res, class arg1, class arg2> struct func<res, arg1, arg2, TV>
{
...
template<class res, class arg1, class arg2> struct func<res, arg1, arg2, TMATV>
{
  static EIGEN_DONT_INLINE res run(arg1 &a1, arg2 &a2)
  {
    asm("");
...
template<class res, class arg1, class arg2> struct func<res, arg1, arg2, TMATVMAT>
{
  static EIGEN_DONT_INLINE res run(arg1 &a1, arg2 &a2)
  {
    asm("");
...
template<class func, class arg1, class arg2> struct test_transform
{
  static void run()
  {
    arg1 a1;
