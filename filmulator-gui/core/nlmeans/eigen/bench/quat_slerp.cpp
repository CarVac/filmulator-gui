...
template<typename Q> EIGEN_DONT_INLINE Q nlerp(const Q &a, const Q &b, typename Q::Scalar t)
{
  return Q((a.coeffs() * (1.0 - t) + b.coeffs() * t).normalized());
}

template<typename Q> EIGEN_DONT_INLINE Q slerp_eigen(const Q &a, const Q &b, typename Q::Scalar t)
{
  return a.slerp(t, b);
}

template<typename Q> EIGEN_DONT_INLINE Q slerp_legacy(const Q &a, const Q &b, typename Q::Scalar t)
{
...
template<typename Q> EIGEN_DONT_INLINE Q slerp_legacy_nlerp(const Q &a, const Q &b, typename Q::Scalar t)
{
  typedef typename Q::Scalar Scalar;
...
template<typename T> inline T sin_over_x(T x)
{
  if (T(1) + x * x == T(1))
    return T(1);
  else
...
template<typename Q> EIGEN_DONT_INLINE Q slerp_rw(const Q &a, const Q &b, typename Q::Scalar t)
{
  typedef typename Q::Scalar Scalar;
...
template<typename Q> EIGEN_DONT_INLINE Q slerp_gael(const Q &a, const Q &b, typename Q::Scalar t)
{
  typedef typename Q::Scalar Scalar;
