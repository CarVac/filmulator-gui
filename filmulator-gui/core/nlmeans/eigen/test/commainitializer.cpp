...
template<int M1, int M2, int N1, int N2> void test_blocks()
{
  ...
  {
    VERIFY_IS_EQUAL(
      (m_fixed << mat11, mat12, mat21, matx22).finished(), (m_dynamic << mat11, matx12, mat21, matx22).finished());
    ...
    VERIFY_IS_EQUAL(
      (m_fixed << mat12, mat11, matx21, mat22).finished(), (m_dynamic << mat12, matx11, matx21, mat22).finished());
  }
  ...
  if (N1 > 0) {
    ...
    VERIFY_IS_EQUAL(
      (m_fixed << mat11, mat12, mat11, mat11, mat21, mat21, mat22).finished(), (m_dynamic << mat12, mat22).finished());
  }
  if (M1 != M2) { VERIFY_RAISES_ASSERT((m_fixed << mat11, mat21, mat12, mat22)); }
}


template<int N> struct test_block_recursion
{
  static void run()
  {
...
template<> struct test_block_recursion<-1>
{
  static void run() {}
};
