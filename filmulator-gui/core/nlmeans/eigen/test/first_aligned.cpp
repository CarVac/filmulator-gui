...
template<typename Scalar> void test_first_aligned_helper(Scalar *array, int size)
{
...
template<typename Scalar> void test_none_aligned_helper(Scalar *array, int size)
{
