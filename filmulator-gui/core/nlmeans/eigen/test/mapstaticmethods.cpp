...
template<typename PlainObjectType, bool IsVector> struct mapstaticmethods_impl<PlainObjectType, false, IsVector>
{
...
template<typename PlainObjectType> struct mapstaticmethods_impl<PlainObjectType, true, false>
{
  static void run(const PlainObjectType &m)
  {
...
template<typename PlainObjectType> struct mapstaticmethods_impl<PlainObjectType, true, true>
{
...
template<typename PlainObjectType> void mapstaticmethods(const PlainObjectType &m)
{
