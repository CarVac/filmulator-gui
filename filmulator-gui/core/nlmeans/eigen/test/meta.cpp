...
template<typename From, typename To> bool check_is_convertible(const From &, const To &)
{
...
void test_meta()
{
  ...
  //   VERIFY((!internal::is_convertible<Matrix3f,Matrix3d>::value )); //does not work because the conversion is
  //   prevented by a static assertion
