...
template<typename TC, typename TA, typename TB> const TC &ref_prod(TC &C, const TA &A, const TB &B)
{
...
typename internal::enable_if<
  !((Rows == 1 && Depth != 1 && OA == ColMajor) || (Depth == 1 && Rows != 1 && OA == RowMajor)
...
template<typename T> void test_lazy_l1()
{
...
template<typename T> void test_lazy_l2()
{
  int rows = internal::random<int>(1, 12);
  int cols = internal::random<int>(1, 12);
  int depth = internal::random<int>(1, 12);
...
template<typename T> void test_lazy_l3()
{
  int rows = internal::random<int>(1, 12);
  int cols = internal::random<int>(1, 12);
  int depth = internal::random<int>(1, 12);
...
template<typename T, int N, int M, int K> void test_linear_but_not_vectorizable()
{
...
template<int Rows> void bug_1311()
{
