...
template<typename MatrixType> void check_stddeque_matrix(const MatrixType &m)
{
...
template<typename TransformType> void check_stddeque_transform(const TransformType &)
{
