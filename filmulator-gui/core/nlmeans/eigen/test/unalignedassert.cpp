...
template<typename T> void check_unalignedassert_good()
{
  T *x, *y;
  x = new T;
  delete x;
...
template<typename T> void construct_at_boundary(int boundary)
{
...
void test_unalignedassert() { CALL_SUBTEST(unalignedassert()); }
