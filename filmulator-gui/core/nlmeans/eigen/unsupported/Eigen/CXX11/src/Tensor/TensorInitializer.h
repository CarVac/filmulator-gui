...
namespace internal {
  ...
  template<typename Derived, int N> struct Initializer
  {
  ...
  template<typename Derived> struct Initializer<Derived, 1>
  {
  ...
  template<typename Derived> struct Initializer<Derived, 0>
  {
