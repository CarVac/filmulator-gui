...
namespace TensorSycl {
  ...
  template<typename Expr, typename Dev> void run(Expr &expr, Dev &dev)
  {
      ...
      dev.m_queue.submit([&](cl::sycl::handler &cgh) {
        ...
        cgh.parallel_for<PlaceHolderExpr>(
          ...
          [=](cl::sycl::nd_item<1> itemID) {
            ...
            auto device_evaluator = Eigen::TensorEvaluator<decltype(device_expr.expr), Eigen::DefaultDevice>(
