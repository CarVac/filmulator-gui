...
namespace internal {
  ...
  template<typename Scalar, int Options> class compute_tensor_flags
  {
    enum {
  ...
  template<typename PlainObjectType> struct traits<TensorRef<PlainObjectType>> : public traits<PlainObjectType>
  {
    typedef traits<PlainObjectType> BaseTraits;
    typedef typename BaseTraits::Scalar Scalar;
    typedef typename BaseTraits::StorageKind StorageKind;
  ...
  template<typename PlainObjectType> struct eval<TensorRef<PlainObjectType>, Eigen::Dense>
  {
    typedef const TensorRef<PlainObjectType> &type;
  };

  template<typename PlainObjectType> struct eval<const TensorRef<PlainObjectType>, Eigen::Dense>
  {
    typedef const TensorRef<PlainObjectType> &type;
  };
  ...
  template<typename PlainObjectType> struct nested<TensorRef<PlainObjectType>>
  {
    typedef const TensorRef<PlainObjectType> &type;
  };

  template<typename PlainObjectType> struct nested<const TensorRef<PlainObjectType>>
  {
    typedef const TensorRef<PlainObjectType> &type;
  };
