...
namespace internal {
  ...
  namespace group_theory {
    ...
    {
      typedef typename conditional<Equality<id, t>::value,
        typename strip_identities<Equality, id, type_list<ts...>>::type,
        typename concat<type_list<t>, typename strip_identities<Equality, id, type_list<ts...>>::type>::type>::type
        type;
     ...
     */
    template<template<typename, typename> class Multiply,
    ...
    struct dimino_first_step_elements_helper
      ...
      :// recursive inheritance is too difficult for Doxygen
       public dimino_first_step_elements_helper<Multiply,
         Equality,
         id,
         g,
    ...
    struct dimino_first_step_elements
    {
      ...
      typedef dimino_first_step_elements_helper<Multiply,
        Equality,
        id,
        first_generator,
        first_generator,
    ...
    template<template<typename, typename> class Multiply,
      ...
      typename rep_element,
      int sub_group_size>
    struct dimino_add_cosets_for_rep<Multiply,
      Equality,
      id,
      sub_group_elements,
      elements,
      ...
      sub_group_size>
    {
      ...
      typedef dimino_add_cosets_for_rep<Multiply,
        Equality,
        id,
        sub_group_elements,
    ...
    template<template<typename, typename> class Multiply,
      ...
      typename id,
      typename sub_group_elements,
      typename elements EIGEN_TPL_PP_SPEC_HACK_DEFC(typename, empty),
      typename rep_element,
      int sub_group_size>
    struct dimino_add_cosets_for_rep<Multiply,
      Equality,
    ...
    struct dimino_add_all_coset_spaces
    {
      ...
      typedef dimino_add_all_coset_spaces<Multiply,
        Equality,
        id,
        sub_group_elements,
        new_elements,
    ...
    template<template<typename, typename> class Multiply,
      ...
      int sub_group_size,
      int rep_pos>
    struct dimino_add_all_coset_spaces<Multiply,
      Equality,
      id,
      sub_group_elements,
      elements,
    ...
    struct dimino_add_remaining_generators
    {
      ...
      typedef dimino_add_generator<Multiply, Equality, id, elements, generators_done, first_generator, _cil::value>
        _helper;

      typedef typename _helper::type new_elements;

      typedef dimino_add_remaining_generators<Multiply,
        Equality,
        id,
    ...
    struct enumerate_group_elements
      : public enumerate_group_elements_noid<Multiply,
          Equality,
          id,
