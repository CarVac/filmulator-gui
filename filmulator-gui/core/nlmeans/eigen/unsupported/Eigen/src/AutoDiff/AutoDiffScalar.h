...
class AutoDiffScalar
  : public internal::auto_diff_special_op<_DerType,
      !internal::is_same<typename internal::traits<typename internal::remove_all<_DerType>::type>::Scalar,
        typename NumTraits<typename internal::traits<typename internal::remove_all<_DerType>::type>::Scalar>::Real>::
        value>
{
public:
  typedef internal::auto_diff_special_op<_DerType,
    !internal::is_same<typename internal::traits<typename internal::remove_all<_DerType>::type>::Scalar,
      typename NumTraits<typename internal::traits<typename internal::remove_all<_DerType>::type>::Scalar>::Real>::
      value>
    Base;
  ...
  template<typename OtherDerType> inline bool operator<(const AutoDiffScalar<OtherDerType> &b) const
  {
  ...
  inline const AutoDiffScalar<EIGEN_EXPR_BINARYOP_SCALAR_RETURN_TYPE(
    CwiseBinaryOp<internal::scalar_difference_op<Scalar> EIGEN_COMMA const
        EIGEN_EXPR_BINARYOP_SCALAR_RETURN_TYPE(DerType, Scalar, product) EIGEN_COMMA const
          EIGEN_EXPR_BINARYOP_SCALAR_RETURN_TYPE(typename internal::remove_all<OtherDerType>::type, Scalar, product)>,
    Scalar,
    product)>
    operator/(const AutoDiffScalar<OtherDerType> &other) const
  {
    ...
    operator*(const AutoDiffScalar<OtherDerType> &other) const
  {
    ...
    return MakeAutoDiffScalar(
      m_value * other.value(), (m_derivatives * other.value()) + (other.derivatives() * m_value));
  }
...
namespace internal {
  ...
  template<typename _DerType> struct auto_diff_special_op<_DerType, true>
...
inline AutoDiffScalar<typename Eigen::internal::remove_all<DerType>::type::PlainObject>(
...
template<typename DerType>
inline AutoDiffScalar<typename Eigen::internal::remove_all<DerType>::type::PlainObject>(
  min)(const AutoDiffScalar<DerType> &x, const AutoDiffScalar<DerType> &y)
{
  return (x.value() < y.value() ? x : y);
}
template<typename DerType>
inline AutoDiffScalar<typename Eigen::internal::remove_all<DerType>::type::PlainObject>(
  max)(const AutoDiffScalar<DerType> &x, const AutoDiffScalar<DerType> &y)
{
  return (x.value() >= y.value() ? x : y);
}
...
EIGEN_AUTODIFF_DECLARE_GLOBAL_UNARY(acos, using std::sqrt; using std::acos;
  return Eigen::MakeAutoDiffScalar(acos(x.value()),
