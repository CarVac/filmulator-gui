...
namespace internal {
  ...
  template<typename _Scalar> struct kiss_cpx_fft
  {
    ...
    inline void make_twiddles(int nfft, bool inverse)
    {
      ...
      for (int i = 0; i < nfft; ++i) m_twiddles[i] = exp(Complex(0, i * phinc));
    }
    ...
    inline void work(int stage, Complex *xout, const _Src *xin, size_t fstride, size_t in_stride)
    {
    ...
    inline void bfly5(Complex *Fout, const size_t fstride, const size_t m)
    {
      ...
      for (u = 0; u < m; ++u) {
        ...
        *Fout0 += scratch[8];
        ...
        scratch[5] = scratch[0]
                     + Complex((scratch[7].real() * ya.real()) + (scratch[8].real() * yb.real()),
        ...
        *Fout4 = scratch[5] + scratch[6];
        ...
        scratch[11] = scratch[0]
                      + Complex((scratch[7].real() * yb.real()) + (scratch[8].real() * ya.real()),
  ...
  template<typename _Scalar> struct kissfft_impl
  {
    typedef _Scalar Scalar;
    typedef std::complex<Scalar> Complex;
