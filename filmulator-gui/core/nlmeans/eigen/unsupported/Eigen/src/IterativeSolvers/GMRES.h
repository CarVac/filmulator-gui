...
namespace internal {
  ...
  bool gmres(const MatrixType &mat,
    const Rhs &rhs,
    Dest &x,
...
namespace internal {
  ...
  template<typename _MatrixType, typename _Preconditioner> struct traits<GMRES<_MatrixType, _Preconditioner>>
  {
...
public:
   ...
   */
  template<typename MatrixDerived> explicit GMRES(const EigenBase<MatrixDerived> &A) : Base(A.derived()), m_restart(30)
  {}
