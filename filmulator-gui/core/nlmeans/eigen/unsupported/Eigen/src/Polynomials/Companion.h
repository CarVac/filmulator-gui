...
namespace internal {
  ...
  template<typename T> T radix() { return 2; }

  template<typename T> T radix2() { return radix<T>() * radix<T>(); }
  ...
  public:
    DenseCompanionMatrixType denseMatrix() const
    {
      ...
      companion << (LeftBlock(deg, deg_1) << LeftBlockFirstRow::Zero(1, deg_1),
  ...
  inline bool
    companion<_Scalar, _Deg>::balanced(Scalar colNorm, Scalar rowNorm, bool &isBalanced, Scalar &colB, Scalar &rowB)
  {
  ...
  template<typename _Scalar, int _Deg>
  inline bool
    companion<_Scalar, _Deg>::balancedR(Scalar colNorm, Scalar rowNorm, bool &isBalanced, Scalar &colB, Scalar &rowB)
  {
    if (Scalar(0) == colNorm || Scalar(0) == rowNorm) {
      return true;
    } else {
