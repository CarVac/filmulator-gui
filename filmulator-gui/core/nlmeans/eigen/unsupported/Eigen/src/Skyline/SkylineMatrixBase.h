...
public:
  ...
  template<typename OtherDerived> inline Derived &operator=(const SkylineMatrixBase<OtherDerived> &other)
  {
    // TODO
  }
  ...
  template<typename DenseDerived> void evalTo(MatrixBase<DenseDerived> &dst) const
  {
    dst.setZero();
