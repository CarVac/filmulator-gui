...
namespace internal {
  ...
  inline bool
    GetMarketLine(std::stringstream &line, IndexType &M, IndexType &N, IndexType &i, IndexType &j, Scalar &value)
  {
    line >> i >> j >> value;
    i--;
    j--;
  ...
  template<typename Scalar, typename IndexType>
  inline bool GetMarketLine(std::stringstream &line,
    IndexType &M,
    IndexType &N,
    IndexType &i,
    IndexType &j,
  ...
  template<typename Scalar> inline void PutMatrixElt(Scalar value, int row, int col, std::ofstream &out)
  {
    out << row << " " << col << " " << value << "\n";
  }
  template<typename Scalar> inline void PutMatrixElt(std::complex<Scalar> value, int row, int col, std::ofstream &out)
  {
  ...
  template<typename Scalar> inline void putVectorElt(std::complex<Scalar> value, std::ofstream &out)
  {
...
template<typename SparseMatrixType> bool loadMarket(SparseMatrixType &mat, const std::string &filename)
{
  ...
  if (count != NNZ) std::cerr << count << "!=" << NNZ << "\n";
