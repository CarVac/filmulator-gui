...
namespace internal {
  ...
  namespace cephes {
     ...
     *
     */
    template<typename Scalar, int N> struct polevl
    {
      EIGEN_DEVICE_FUNC
    ...
    template<typename Scalar> struct polevl<Scalar, 0>
    {
      EIGEN_DEVICE_FUNC
      static EIGEN_STRONG_INLINE Scalar run(const Scalar, const Scalar coef[]) { return coef[0]; }
    };
  ...
  template<typename Scalar> struct lgamma_impl
  {
    EIGEN_DEVICE_FUNC
  ...
  template<typename Scalar> struct lgamma_retval
  {
    typedef Scalar type;
  };

#if EIGEN_HAS_C99_MATH
  template<> struct lgamma_impl<float>
  {
    EIGEN_DEVICE_FUNC
  ...
  template<> struct lgamma_impl<double>
  {
    EIGEN_DEVICE_FUNC
  ...
  template<typename Scalar> struct digamma_retval
  {
    typedef Scalar type;
  };
   ...
   *
   */
  template<typename Scalar> struct digamma_impl_maybe_poly
  {
    EIGEN_DEVICE_FUNC
    static EIGEN_STRONG_INLINE Scalar run(const Scalar)
    {
  ...
  template<> struct digamma_impl_maybe_poly<float>
  {
    EIGEN_DEVICE_FUNC
    static EIGEN_STRONG_INLINE float run(const float s)
    {
      const float A[] = {
        -4.16666666666666666667E-3f, 3.96825396825396825397E-3f, -8.33333333333333333333E-3f, 8.33333333333333333333E-2f
      };
  ...
  template<> struct digamma_impl_maybe_poly<double>
  {
    EIGEN_DEVICE_FUNC
  ...
  template<typename Scalar> struct digamma_impl
  {
    EIGEN_DEVICE_FUNC
  ...
  template<typename Scalar> struct erf_impl
  {
    EIGEN_DEVICE_FUNC
    static EIGEN_STRONG_INLINE Scalar run(const Scalar)
    {
  ...
  template<typename Scalar> struct erf_retval
  {
    typedef Scalar type;
  };

#if EIGEN_HAS_C99_MATH
  template<> struct erf_impl<float>
  {
    EIGEN_DEVICE_FUNC
    static EIGEN_STRONG_INLINE float run(float x) { return ::erff(x); }
  };

  template<> struct erf_impl<double>
  {
    EIGEN_DEVICE_FUNC
  ...
  template<typename Scalar> struct erfc_impl
  {
    EIGEN_DEVICE_FUNC
    static EIGEN_STRONG_INLINE Scalar run(const Scalar)
    {
  ...
  template<typename Scalar> struct erfc_retval
  {
    typedef Scalar type;
  };

#if EIGEN_HAS_C99_MATH
  template<> struct erfc_impl<float>
  {
    EIGEN_DEVICE_FUNC
    static EIGEN_STRONG_INLINE float run(const float x) { return ::erfcf(x); }
  };

  template<> struct erfc_impl<double>
  {
    EIGEN_DEVICE_FUNC
  ...
  template<typename Scalar> struct igammac_retval
  {
    typedef Scalar type;
  };

  // NOTE: cephes_helper is also used to implement zeta
  template<typename Scalar> struct cephes_helper
  {
    EIGEN_DEVICE_FUNC
  ...
  template<> struct cephes_helper<float>
  {
    EIGEN_DEVICE_FUNC
  ...
  template<> struct cephes_helper<double>
  {
    EIGEN_DEVICE_FUNC
    ...
    EIGEN_DEVICE_FUNC
    static EIGEN_STRONG_INLINE double big() { return 1.0 / NumTraits<double>::epsilon(); }
    EIGEN_DEVICE_FUNC
  ...
  template<typename Scalar> struct igammac_impl
  {
    EIGEN_DEVICE_FUNC
  ...
  template<typename Scalar> struct igamma_retval
  {
    typedef Scalar type;
  };
  ...
  template<typename Scalar> struct igamma_impl
  {
    EIGEN_DEVICE_FUNC
  ...
  template<typename Scalar> struct zeta_retval
  {
    typedef Scalar type;
  };

  template<typename Scalar> struct zeta_impl_series
  {
    EIGEN_DEVICE_FUNC
    static EIGEN_STRONG_INLINE Scalar run(const Scalar)
    {
  ...
  template<> struct zeta_impl_series<float>
  {
    EIGEN_DEVICE_FUNC
  ...
  template<> struct zeta_impl_series<double>
  {
    EIGEN_DEVICE_FUNC
  ...
  template<typename Scalar> struct zeta_impl
  {
    EIGEN_DEVICE_FUNC
    static Scalar run(Scalar x, Scalar q)
    {
      ...
      if (q <= zero) {
        if (q == numext::floor(q)) { return maxnum; }
        p = x;
        r = numext::floor(p);
        if (p != r) return nan;
      }
      ...
      if (zeta_impl_series<Scalar>::run(a, b, s, x, machep)) { return s; }
  ...
  template<typename Scalar> struct polygamma_retval
  {
    typedef Scalar type;
  };
  ...
  template<typename Scalar> struct polygamma_impl
  {
    EIGEN_DEVICE_FUNC
  ...
  template<typename Scalar> struct betainc_retval
  {
    typedef Scalar type;
  };
  ...
  template<typename Scalar> struct betainc_impl
  {
    EIGEN_DEVICE_FUNC
   ...
   */
  template<typename Scalar> struct incbeta_cfe
  {
    EIGEN_DEVICE_FUNC
    static EIGEN_STRONG_INLINE Scalar run(Scalar a, Scalar b, Scalar x, bool small_branch)
    {
      ...
      do {
        ...
        if (qk != zero) {
          r = pk / qk;
          if (numext::abs(ans - r) < numext::abs(r) * thresh) { return r; }
          ans = r;
        }
  ...
  template<typename Scalar> struct betainc_helper
  {
  };

  template<> struct betainc_helper<float>
  {
  ...
  template<> struct betainc_impl<float>
  {
    EIGEN_DEVICE_FUNC
  ...
  template<> struct betainc_helper<double>
  {
    EIGEN_DEVICE_FUNC
  ...
  template<> struct betainc_impl<double>
  {
    EIGEN_DEVICE_FUNC
    static double run(double aa, double bb, double xx)
    {
      ...
      if ((bb * xx) <= 1.0 && xx <= 0.95) { return betainc_helper<double>::incbps(aa, bb, xx); }
...
namespace numext {
  ...
  template<typename Scalar> EIGEN_DEVICE_FUNC inline EIGEN_MATHFUNC_RETVAL(lgamma, Scalar) lgamma(const Scalar &x)
  {
    return EIGEN_MATHFUNC_IMPL(lgamma, Scalar)::run(x);
  }

  template<typename Scalar> EIGEN_DEVICE_FUNC inline EIGEN_MATHFUNC_RETVAL(digamma, Scalar) digamma(const Scalar &x)
  {
  ...
  template<typename Scalar> EIGEN_DEVICE_FUNC inline EIGEN_MATHFUNC_RETVAL(erf, Scalar) erf(const Scalar &x)
  {
    return EIGEN_MATHFUNC_IMPL(erf, Scalar)::run(x);
  }

  template<typename Scalar> EIGEN_DEVICE_FUNC inline EIGEN_MATHFUNC_RETVAL(erfc, Scalar) erfc(const Scalar &x)
  {
