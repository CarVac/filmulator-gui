...
public:
   ...
   **/
  template<int DerivativeOrder>
  typename SplineTraits<Spline, DerivativeOrder>::BasisDerivativeType basisFunctionDerivatives(Scalar u,
    DenseIndex order = DerivativeOrder) const;
...
template<typename _Scalar, int _Dim, int _Degree>
typename Spline<_Scalar, _Dim, _Degree>::BasisVectorType Spline<_Scalar, _Dim, _Degree>::BasisFunctions(
...
template<typename _Scalar, int _Dim, int _Degree>
typename SplineTraits<Spline<_Scalar, _Dim, _Degree>>::BasisVectorType Spline<_Scalar, _Dim, _Degree>::basisFunctions(
  Scalar u) const
{
