...
template<typename T> std::complex<T> RandomCpx()
{
...
template<typename T> complex<long double> promote(complex<T> x)
{
...
template<typename VT1, typename VT2> long double fft_rmse(const VT1 &fftbuf, const VT2 &timebuf)
{
...
template<typename VT1, typename VT2> long double dif_rmse(const VT1 buf1, const VT2 buf2)
{
  long double totalpower = 0;
  long double difpower = 0;
...
template<int Container, typename T> void test_scalar_generic(int nfft)
{
...
template<typename T> void test_scalar(int nfft)
{
...
template<int Container, typename T> void test_complex_generic(int nfft)
{
  typedef typename FFT<T>::Complex Complex;
  typedef typename VectorType<Container, Complex>::type ComplexVector;
...
template<typename T> void test_complex(int nfft)
{
