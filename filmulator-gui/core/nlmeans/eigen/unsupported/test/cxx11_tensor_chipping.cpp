...
template<int DataLayout> static void test_simple_chip()
{
  ...
  for (int i = 0; i < 3; ++i) {
    for (int j = 0; j < 5; ++j) {
      for (int k = 0; k < 7; ++k) {
        for (int l = 0; l < 11; ++l) { VERIFY_IS_EQUAL(chip1(i, j, k, l), tensor(1, i, j, k, l)); }
      }
    }
  }
  ...
  for (int i = 0; i < 2; ++i) {
    for (int j = 0; j < 3; ++j) {
      for (int k = 0; k < 7; ++k) {
        for (int l = 0; l < 11; ++l) { VERIFY_IS_EQUAL(chip2(i, j, k, l), tensor(i, 1, j, k, l)); }
      }
    }
  }
  ...
  for (int i = 0; i < 2; ++i) {
    for (int j = 0; j < 3; ++j) {
      for (int k = 0; k < 7; ++k) {
        for (int l = 0; l < 11; ++l) { VERIFY_IS_EQUAL(chip3(i, j, k, l), tensor(i, j, 2, k, l)); }
      }
    }
  }
  ...
  for (int i = 0; i < 2; ++i) {
    for (int j = 0; j < 3; ++j) {
      for (int k = 0; k < 5; ++k) {
        for (int l = 0; l < 7; ++l) { VERIFY_IS_EQUAL(chip4(i, j, k, l), tensor(i, j, k, 5, l)); }
      }
    }
  }
  ...
  for (int i = 0; i < 2; ++i) {
    for (int j = 0; j < 3; ++j) {
      for (int k = 0; k < 5; ++k) {
        for (int l = 0; l < 7; ++l) { VERIFY_IS_EQUAL(chip5(i, j, k, l), tensor(i, j, k, l, 7)); }
      }
    }
  }
}
