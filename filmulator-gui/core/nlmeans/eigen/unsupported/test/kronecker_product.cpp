...
template<typename MatrixType> void check_dimension(const MatrixType &ab, const int rows, const int cols)
{
...
template<typename MatrixType> void check_kronecker_product(const MatrixType &ab)
{
...
template<typename MatrixType> void check_sparse_kronecker_product(const MatrixType &ab)
{
