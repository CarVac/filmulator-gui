...
// Returns cluster centers (dimensions major), isInSecondCluster, summed square distances, number of points in each
// cluster.
std::tuple<std::vector<float>, std::vector<bool>, std::array<double, 2>, std::array<int, 2>>
  splitCluster(float *__restrict const X, const int numPoints)
{
