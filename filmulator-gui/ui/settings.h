...
class Settings : public QObject
{
  ...
  Q_PROPERTY(QDate organizeCaptureDate READ getOrganizeCaptureDate WRITE setOrganizeCaptureDate NOTIFY
      organizeCaptureDateChanged)
  ...
  Q_PROPERTY(
    bool useSystemLanguage READ getUseSystemLanguage WRITE setUseSystemLanguage NOTIFY useSystemLanguageChanged)
